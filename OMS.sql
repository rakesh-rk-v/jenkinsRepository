...
CREATE TABLE billing_accounts (
  ...
  BILLING_ACCOUNT_NAME varchar(50) CHARACTER SET utf8mb3 NOT NULL DEFAULT '-1' COMMENT 'To Identify the Billing Account Name for Postpaid Customer',
...
CREATE TABLE customer_credits_adjustments (
  ...
  REASON_CODE varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
  REASON_DESCRIPTION varchar(255) DEFAULT NULL,
  STATUS smallint NOT NULL DEFAULT '11',
  CREATED_BY varchar(50) DEFAULT NULL,
  CREATED_ON timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE customer_master (
  ...
  MODIFIED_BY varchar(50) DEFAULT NULL,
  MODIFIED_IPADDR varchar(100) DEFAULT NULL,
  MIG_CUSTOMR_ID varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
...
CREATE TABLE service_level_details_bkp (
  ...
  SERVICE_LEVEL varchar(25) CHARACTER SET utf8mb3 DEFAULT NULL,
  SERVICE_DIRECTION varchar(25) CHARACTER SET utf8mb3 DEFAULT NULL,
  EFFECTIVE_FROM date NOT NULL,
  EFFECTIVE_TO date NOT NULL DEFAULT '9999-12-31',
  STATUS smallint NOT NULL DEFAULT '0',
  CREATED_BY varchar(50) CHARACTER SET utf8mb3 DEFAULT NULL,
  CREATED_IPADDR varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
  CREATED_ON timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  MODIFIED_BY varchar(50) CHARACTER SET utf8mb3 DEFAULT NULL,
  MODIFIED_IPADDR varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
  MODIFIED_ON timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP /* ON UPDATE CURRENT_TIMESTAMP */
) ;
...
CREATE TABLE work_orders (
  ...
  MODIFIED_ON timestamp(0) DEFAULT NULL,
  MODIFIED_IPADDR varchar(100) DEFAULT NULL,
  MIG_WORK_ORDER_ID varchar(100) CHARACTER SET utf8mb3 DEFAULT NULL,
  PRIMARY KEY (WORK_ORDER_ID)
,
